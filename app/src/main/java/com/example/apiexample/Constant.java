...
public class Constant {
    ...
    public static final String REGION_DATA_TABLE_NAME = "REGION_DATA_TABLE_NAME";
    public static final String REGION_DATA_MY_REGION_TABLE_NAME = "REGION_DATA_MY_REGION_TABLE_NAME";
    public static final String REGION_DATA_LOCATION_ID_TABLE_NAME = "REGION_DATA_LOCATION_ID_TABLE_NAME";
...
//    public static final String SERVER_BASE_URL = "https://oneulbionya.ga:8443/";
    ...
    public static final int MAX_LOCATION_COUNT = 6;
    public static final int MAX_MY_ADD_LOCATION_COUNT = 5;
